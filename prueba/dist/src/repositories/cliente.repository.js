...
exports.ClienteRepositoryService = exports.ClienteRepository = void 0;
        ...
        return new Promise((resolve, reject) => {
            dbConn
                ...
                pool.request()
                    ...
                    .execute('[dbo].[crearCliente]', (err, result) => {
    ...
    comprasCliente() {
        ...
        return new Promise((resolve, reject) => {
            dbConn
                .connect()
                .then(pool => {
                pool.request().execute('[dbo].[getClient]', (err, result) => {
        ...
        return new Promise((resolve, reject) => {
            dbConn
                ...
                pool.request()
                    ...
                    .execute('[dbo].[borrarClient]', (err, result) => {
                    console.log('result', result.rowsAffected);
                    resolve(result.rowsAffected);
                });
            }).catch(err => {
...
exports.ClienteRepositoryService = new typedi_1.Token();

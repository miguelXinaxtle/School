...
exports.VentaRepositoryService = exports.VentaRepository = void 0;
...
let VentaRepository = class VentaRepository {
    constructor() {
    }
    getVenta(dateInicial, dateFinal) {
        ...
        return new Promise((resolve, reject) => {
            dbConn
                ...
                pool.request()
                    ...
                    .execute('[dbo].[getVenta]', (err, result) => {
    ...
    masVendidos(fechaInicial, fechaFinal) {
        var dbConn = new sql.ConnectionPool(sqlConfig);
        return new Promise((resolve, reject) => {
            dbConn
                .connect()
                ...
                pool.request()
                    ...
                    .execute('[dbo].[masVendidos]', (err, result) => {
                    console.log('result', err);
                    console.log('result', result);
                    console.log('result', result.recordset);
                    resolve(result.recordset);
...
exports.VentaRepository = VentaRepository = __decorate([
    (0, typedi_1.Service)(),
    __metadata("design:paramtypes", [])
], VentaRepository);
exports.VentaRepositoryService = new typedi_1.Token();

...
exports.ProductoRepositoryService = exports.ProductoRepository = void 0;
        ...
        return new Promise((resolve, reject) => {
            dbConn
                ...
                pool.request()
                    ...
                    .execute('[dbo].[getProductoPorDepartamento]', (err, result) => {
        ...
        return new Promise((resolve, reject) => {
            dbConn
                ...
                pool.request()
                    ...
                    .execute('[dbo].[getProductoPorDescripcion]', (err, result) => {
                    console.log('result', result.recordset);
                    resolve(result.recordset);
                });
            }).catch(err => {
    ...
    getProducto() {
        ...
        return new Promise((resolve, reject) => {
            dbConn
                .connect()
                .then(pool => {
                pool.request().execute('[dbo].[getProducto]', (err, result) => {
                    console.log('result', result.recordset);
                    resolve(result.recordset);
                });
            }).catch(err => {
        ...
        return new Promise((resolve, reject) => {
            dbConn
                ...
                pool.request()
                    ...
                    .input('idProducto', body.idProducto)
                    .execute('[dbo].[updateInventario]', (err, result) => {
                    console.log('result', result.rowsAffected);
                    resolve(result.rowsAffected);
                });
            }).catch(err => {
    ...
    productoAbastecer() {
        ...
        return new Promise((resolve, reject) => {
            dbConn
                .connect()
                .then(pool => {
                pool.request().execute('[dbo].[productosPorComprar]', (err, result) => {
                    console.log('result', result.recordset);
                    resolve(result.recordset);
                });
            }).catch(err => {
        ...
        return new Promise((resolve, reject) => {
            dbConn
                ...
                pool.request()
                    ...
                    .execute('[dbo].[borrarProduct]', (err, result) => {
                    console.log('result', result.rowsAffected);
                    resolve(result.rowsAffected);
                });
            }).catch(err => {
...
exports.ProductoRepositoryService = new typedi_1.Token();

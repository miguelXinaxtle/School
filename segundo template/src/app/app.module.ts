...
} from './elements/dashboard1/graph-market-overview/graph-market-overview.component';
...
} from './elements/dashboard1/graph-crypto-statistics/graph-crypto-statistics.component';
...
} from './elements/coin-details/coin-detail-quick-transfer/coin-detail-quick-transfer.component';
...
} from './charts/apex/line/line-chart-with-datalabels/line-chart-with-datalabels.component';
...
} from './charts/apex/area/area-irregular-timeseries/area-irregular-timeseries.component';
import {
    AreaMissingOrNullValuesComponent
} from './charts/apex/area/area-missing-or-null-values/area-missing-or-null-values.component';
...
} from './charts/apex/column/column-negative-values/column-negative-values.component';
...
} from './charts/apex/mixed/mixed-line-column-area/mixed-line-column-area.component';
...
} from './charts/apex/timeline/timeline-multi-series/timeline-multi-series.component';
...
} from './charts/apex/timeline/timeline-multiple-series/timeline-multiple-series.component';
...
} from './charts/apex/candlestick/candlestick-category/candlestick-category.component';
...
} from './charts/apex/radialbar/radialbar-custom-angle-circle/radialbar-custom-angle-circle.component';
...
} from './charts/apex/radialbar/radialbar-stroked-angular-gauge/radialbar-stroked-angular-gauge.component';
import {
    RadialbarSemiCircleGaugeComponent
} from './charts/apex/radialbar/radialbar-semi-circle-gauge/radialbar-semi-circle-gauge.component';
...
} from './charts/apex/polar-area/polar-area-monochrome/polar-area-monochrome.component';
...
} from './charts/apex/heatmap/heatmap-multiple-colors/heatmap-multiple-colors.component';
import {
    HeatmapMultipleFlippedComponent
} from './charts/apex/heatmap/heatmap-multiple-flipped/heatmap-multiple-flipped.component';
...
} from './charts/apex/treemap/treemap-multiple-series/treemap-multiple-series.component';
...
} from './bootstrap/accordion/accordion-preventchange/accordion-preventchange.component';
...
} from './bootstrap/datepicker/datepicker-range-popup/datepicker-range-popup.component';
...
} from './bootstrap/datepicker/datepicker-custommonth/datepicker-custommonth.component';
import {
    DatepickerFootertemplateComponent
} from './bootstrap/datepicker/datepicker-footertemplate/datepicker-footertemplate.component';
import {
    DatepickerPositiontargetComponent
} from './bootstrap/datepicker/datepicker-positiontarget/datepicker-positiontarget.component';
...
} from './bootstrap/pagination/pagination-customization/pagination-customization.component';
...
} from './bootstrap/popover/popover-tplwithcontext/popover-tplwithcontext.component';
...
} from './bootstrap/progressbar/progressbar-texttypes/progressbar-texttypes.component';
import {
    ProgressbarShowvalueComponent
} from './bootstrap/progressbar/progressbar-showvalue/progressbar-showvalue.component';
...
} from './bootstrap/timepicker/timepicker-validation/timepicker-validation.component';
...
} from './bootstrap/tooltip/tooltip-tplwithcontext/tooltip-tplwithcontext.component';
...
} from './bootstrap/typeahead/typeahead-prevent-manual-entry/typeahead-prevent-manual-entry.component';
...
} from './material/dzmt-autocomplete/dzmt-autocomplete-display/dzmt-autocomplete-display.component';
import {
    DzmtAutocompleteFilterComponent
} from './material/dzmt-autocomplete/dzmt-autocomplete-filter/dzmt-autocomplete-filter.component';
import {
    DzmtAutocompleteFirstActiveComponent
} from './material/dzmt-autocomplete/dzmt-autocomplete-first-active/dzmt-autocomplete-first-active.component';
import {
    DzmtAutocompleteOptgroupComponent
} from './material/dzmt-autocomplete/dzmt-autocomplete-optgroup/dzmt-autocomplete-optgroup.component';
import {
    DzmtAutocompleteOverviewComponent
} from './material/dzmt-autocomplete/dzmt-autocomplete-overview/dzmt-autocomplete-overview.component';
import {
    DzmtAutocompletePlaneComponent
} from './material/dzmt-autocomplete/dzmt-autocomplete-plane/dzmt-autocomplete-plane.component';
import {
    DzmtAutocompleteSimpleComponent
} from './material/dzmt-autocomplete/dzmt-autocomplete-simple/dzmt-autocomplete-simple.component';
...
} from './material/dzmt-button/dzmt-button-varieties/dzmt-button-varieties.component';
...
} from './material/dzmt-button-toggle/button-toggle-appearance/button-toggle-appearance.component';
import {
    ButtonExclusiveSelectionComponent
} from './material/dzmt-button-toggle/button-exclusive-selection/button-exclusive-selection.component';
...
} from './material/dzmt-button-toggle/button-basic-toggles/button-basic-toggles.component';

import {DzmtCardComponent} from './material/dzmt-card/dzmt-card.component';

import {
    CardMultipleSectionsComponent
} from './material/dzmt-card/card-multiple-sections/card-multiple-sections.component';
...
} from './material/dzmt-checkbox/configurable-checkbox/configurable-checkbox.component';
...
} from './material/dzmt-datepicker/range-custom-selection-strategy/range-custom-selection-strategy.component';
import {
    DatepickerActionButtonsComponent
} from './material/dzmt-datepicker/datepicker-action-buttons/datepicker-action-buttons.component';
import {
    DatepickerOpenMethodComponent
} from './material/dzmt-datepicker/datepicker-open-method/datepicker-open-method.component';
import {
    DatepickerPaletteColorsComponent
} from './material/dzmt-datepicker/datepicker-palette-colors/datepicker-palette-colors.component';
import {
    DatepickerCustomCalendarHeaderComponent
} from './material/dzmt-datepicker/datepicker-custom-calendar-header/datepicker-custom-calendar-header.component';
import {
    DatepickerCustomDateClassesComponent
} from './material/dzmt-datepicker/datepicker-custom-date-classes/datepicker-custom-date-classes.component';
import {
    DisabledDatepickerComponent
} from './material/dzmt-datepicker/disabled-datepicker/disabled-datepicker.component';
...
} from './material/dzmt-datepicker/datepicker-filter-validation/datepicker-filter-validation.component';
import {
    DatepickerMinMaxValidationComponent
} from './material/dzmt-datepicker/datepicker-min-max-validation/datepicker-min-max-validation.component';
...
} from './material/dzmt-datepicker/datepicker-start-date/datepicker-start-date.component';
...
} from './material/dzmt-datepicker/datepicker-selected-value/datepicker-selected-value.component';
...
} from './material/dzmt-expansion/expand-collapse-all-toggles/expand-collapse-all-toggles.component';
import {
    BasicExpansionPanelComponent
} from './material/dzmt-expansion/basic-expansion-panel/basic-expansion-panel.component';
import {
    ExpansionAsAccordionComponent
} from './material/dzmt-expansion/expansion-as-accordion/expansion-as-accordion.component';

import {DzmtFormFieldComponent} from './material/dzmt-form-field/dzmt-form-field.component';
import {
    AppearanceVariantsComponent
} from './material/dzmt-form-field/appearance-variants/appearance-variants.component';
import {
    FieldWithErrorMessagesComponent
} from './material/dzmt-form-field/field-with-error-messages/field-with-error-messages.component';
...
} from './material/dzmt-form-field/field-with-prefix-suffix/field-with-prefix-suffix.component';
...
} from './material/dzmt-input/input-with-clear-button/input-with-clear-button.component';
import {
    InputErrorStateMatcherComponent
} from './material/dzmt-input/input-error-state-matcher/input-error-state-matcher.component';
import {
    InputWithErrorMessageComponent
} from './material/dzmt-input/input-with-error-message/input-with-error-message.component';
...
} from './material/dzmt-input/inputs-with-prefixes-suffixes/inputs-with-prefixes-suffixes.component';
...
} from './material/dzmt-list/list-with-single-selection/list-with-single-selection.component';
...
} from './material/dzmt-paginator/configurable-paginator/configurable-paginator.component';
...
} from './material/dzmt-progress-bar/buffer-progress-bar/buffer-progress-bar.component';
import {
    ConfigurableProgressBarComponent
} from './material/dzmt-progress-bar/configurable-progress-bar/configurable-progress-bar.component';
import {
    DeterminateProgressBarComponent
} from './material/dzmt-progress-bar/determinate-progress-bar/determinate-progress-bar.component';
import {
    IndeterminateProgressBarComponent
} from './material/dzmt-progress-bar/indeterminate-progress-bar/indeterminate-progress-bar.component';
...
} from './material/dzmt-progress-spinner/configurable-progress-spinner/configurable-progress-spinner.component';
import {
    BasicProgressSpinnerComponent
} from './material/dzmt-progress-spinner/basic-progress-spinner/basic-progress-spinner.component';
...
} from './material/dzmt-select/custom-error-state-matcher/custom-error-state-matcher.component';
...
} from './material/dzmt-select/select-form-field-features/select-form-field-features.component';
import {
    InitialValueNoFormComponent
} from './material/dzmt-select/initial-value-no-form/initial-value-no-form.component';
...
} from './material/dzmt-select/select-in-reactive-form/select-in-reactive-form.component';
import {
    SelectWithResetOptionComponent
} from './material/dzmt-select/select-with-reset-option/select-with-reset-option.component';
import {
    TwoWayValueBindingComponent
} from './material/dzmt-select/two-way-value-binding/two-way-value-binding.component';
...
} from './material/dzmt-sidenav/drawer-explicit-backdrop-setting/drawer-explicit-backdrop-setting.component';
...
} from './material/dzmt-slide-toggle/configurable-slide-toggle/configurable-slide-toggle.component';
import {
    SlideToggleWithFormsComponent
} from './material/dzmt-slide-toggle/slide-toggle-with-forms/slide-toggle-with-forms.component';
...
} from './material/dzmt-slider/custom-thumb-label-formatting/custom-thumb-label-formatting.component';
...
} from './material/dzmt-snack-bar/snack-bar-custom-component/snack-bar-custom-component.component';
...
} from './material/dzmt-snack-bar/snack-bar-configurable/snack-bar-configurable.component';
...
} from './material/dzmt-stepper/displays-errors-in-steps/displays-errors-in-steps.component';
import {
    LabelBottomPositionComponent
} from './material/dzmt-stepper/label-bottom-position/label-bottom-position.component';
...
} from './material/dzmt-stepper/stepper-customized-states/stepper-customized-states.component';
...
} from './material/dzmt-table/dynamically-changing-columns-displayed/dynamically-changing-columns-displayed.component';
import {
    TableExpandableRowsComponent
} from './material/dzmt-table/table-expandable-rows/table-expandable-rows.component';
...
} from './material/dzmt-table/table-with-display-flex/table-with-display-flex.component';
...
} from './material/dzmt-table/retrieving-data-through-http/retrieving-data-through-http.component';
import {
    MultipleHeaderFooterRowsComponent
} from './material/dzmt-table/multiple-header-footer-rows/multiple-header-footer-rows.component';
import {
    DataTableSortingPaginationFilteringComponent
} from './material/dzmt-table/data-table-sorting-pagination-filtering/data-table-sorting-pagination-filtering.component';
import {
    TableWithPaginationComponent
} from './material/dzmt-table/table-with-pagination/table-with-pagination.component';
import {
    TableWithReOrderableColumnsComponent
} from './material/dzmt-table/table-with-re-orderable-columns/table-with-re-orderable-columns.component';
import {
    TableContextPropertiesComponent
} from './material/dzmt-table/table-context-properties/table-context-properties.component';
...
} from './material/dzmt-table/table-with-sticky-columns/table-with-sticky-columns.component';
import {
    TableWithToggleAbleStickyHeadersFootersColumnsComponent
} from './material/dzmt-table/table-with-toggle-able-sticky-headers-footers-columns/table-with-toggle-able-sticky-headers-footers-columns.component';
import {
    TableFlexWithToggleAbleStickyHeadersFootersColumnsComponent
} from './material/dzmt-table/table-flex-with-toggle-able-sticky-headers-footers-columns/table-flex-with-toggle-able-sticky-headers-footers-columns.component';
...
} from './material/dzmt-table/table-with-configurations-interface/table-with-configurations-interface.component';
import {
    TableWithSimpleTextHeaderFooterComponent
} from './material/dzmt-table/table-with-simple-text-header-footer/table-with-simple-text-header-footer.component';
...
} from './material/dzmt-tabs/asynchronously-loading-tab-contents/asynchronously-loading-tab-contents.component';
...
} from './material/dzmt-tabs/tabs-with-custom-label-template/tabs-with-custom-label-template.component';
import {
    TabsWithDynamicallyChangingTabsComponent
} from './material/dzmt-tabs/tabs-with-dynamically-changing-tabs/tabs-with-dynamically-changing-tabs.component';
import {
    TabsWithDynamicHeightComponent
} from './material/dzmt-tabs/tabs-with-dynamic-height/tabs-with-dynamic-height.component';
import {
    TabsWithHeadersOnBottomComponent
} from './material/dzmt-tabs/tabs-with-headers-on-bottom/tabs-with-headers-on-bottom.component';
import {
    TabsWithContentLoadedLazilyComponent
} from './material/dzmt-tabs/tabs-with-content-loaded-lazily/tabs-with-content-loaded-lazily.component';
import {
    TabsWithStretchedLabelsComponent
} from './material/dzmt-tabs/tabs-with-stretched-labels/tabs-with-stretched-labels.component';
import {
    TabsWithThemeOptionsComponent
} from './material/dzmt-tabs/tabs-with-theme-options/tabs-with-theme-options.component';
import {
    BasicUseOfTabNavBarComponent
} from './material/dzmt-tabs/basic-use-of-tab-nav-bar/basic-use-of-tab-nav-bar.component';
...
} from './material/dzmt-tooltip/tooltip-with-custom-class/tooltip-with-custom-class.component';
import {
    TooltipWithShowHideDelayComponent
} from './material/dzmt-tooltip/tooltip-with-show-hide-delay/tooltip-with-show-hide-delay.component';
import {
    TooltipCanBeDisabledComponent
} from './material/dzmt-tooltip/tooltip-can-be-disabled/tooltip-can-be-disabled.component';
import {
    TooltipManuallyShowHideComponent
} from './material/dzmt-tooltip/tooltip-manually-show-hide/tooltip-manually-show-hide.component';
import {
    TooltipWithChangingMessageComponent
} from './material/dzmt-tooltip/tooltip-with-changing-message/tooltip-with-changing-message.component';
import {
    TooltipWithHideShowDelayComponent
} from './material/dzmt-tooltip/tooltip-with-hide-show-delay/tooltip-with-hide-show-delay.component';
...
} from './material/dzmt-tooltip/tooltip-with-custom-position/tooltip-with-custom-position.component';
...
} from './material/dzmt-tree/tree-with-dynamic-data/tree-with-dynamic-data.component';
...
} from './material/dzmt-tree/tree-with-partially-loaded-data/tree-with-partially-loaded-data.component';
import {
    TreeWithNestedNodesComponent
} from './material/dzmt-tree/tree-with-nested-nodes/tree-with-nested-nodes.component';
...
} from './elements/widget/visitor-activity/visitor-activity-day/visitor-activity-day.component';
import {
    VisitorActivityMonthComponent
} from './elements/widget/visitor-activity/visitor-activity-month/visitor-activity-month.component';
import {
    VisitorActivityYearComponent
} from './elements/widget/visitor-activity/visitor-activity-year/visitor-activity-year.component';
import {
    ChartjsActiveUsersComponent
} from './elements/widget/charts/chartjs-active-users/chartjs-active-users.component';
...
import {MapaComponent} from "./dashboard/index/mapa/mapa.component";
import {AlertaComponent} from "./dashboard/index/mapa/alerta/alerta.component";

import {DxBulletModule, DxDataGridModule, DxSchedulerModule, DxTemplateModule} from "devextreme-angular";
...
import { HeaderLicenciaComponent } from './licencia/header-licencia/header-licencia.component';
...
import {DetalleMultaComponent} from "./multa/detalle-multa/detalle-multa.component";
...
import { CardComponent } from './autos/card/card.component';
import {ListaAutosComponent} from "./dashboard/index/lista-autos/lista-autos.component";
import {ComportamientoComponent} from "./dashboard/index/comportamiento/comportamiento.component";
...
@NgModule({
    declarations: [
        ...
        PrincipalMultaComponent,
        PrincipalTenenciaComponent,
        ...
        OrdenConsultaComponent,
        MantenimientoSeguimientoComponent,
        DocumentoDashboardComponent,
        DocumentoSeguimientoComponent,
        CitaVerificacionComponent,
        RecojerUnidadComponent,
        CarritoComponent,
        DatosPagoComponent,
        CitaMantenimientoComponent,
        PrincipalLicenciaComponent,
        HeaderLicenciaComponent,
